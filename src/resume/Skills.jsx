    ...
    >
      <div className="w-full lgl:w-1/2">
        <div className="flex flex-col gap-4 py-12 font-titleFont">
          ...
          <h2 className="text-3xl font-bold text-gray-300 md:text-4xl">back end</h2>
        </div>
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="inline-flex w-full h-2 mt-2 rounded-md bgOpacity">
              <motion.span
                ...
                className="relative w-full rounded-md h-ful w-ful bg-gradient-to-r from-blue-600 via-pink-500 to-red-500"
              >
      ...
      <div className="w-full lgl:w-1/2">
        <div className="flex flex-col gap-4 py-12 font-titleFont">
          ...
          <h2 className="text-3xl font-bold text-gray-300 md:text-4xl">Development Skill</h2>
        </div>
