            ...
            <div className="flex flex-col justify-between w-full h-auto lgl:flex-row P-4">
              ...
              <div className="w-full lgl:w-[60%] h-full flex flex-col justify-between">
                ...
                <div className="w-full h-[70%] py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] rounded-lg shadow-shadowOne p-4 lgl:p-8 flex flex-col justify-center gap-4 lgl:gap-8">
                  <div className="flex flex-col justify-between py-6 border-b-2 lgl:items-center border-b-gray-900">
                    <div>
                      ...
                      <p className="mt-3 text-base text-gray-400">
                        via Upwork - Mar 4, 2020 - Aug 30, 2021
                      </p>
                    </div>
                  ...
                  <p className="text-base font-medium leading-6 tracking-wide text-white-400 font-titleFont">
            ...
            <div className="flex flex-col justify-between w-full h-auto lgl:flex-row">
              <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-8 rounded-lg shadow-shadowOne flex flex-col md:flex-row lgl:flex-col gap-8 justify-center md:justify-start lgl:justify-center">
                ...
                <div className="flex flex-col justify-end w-full">
                  ...
                  <h3 className="text-2xl font-bold">Jone Duone Joe</h3>
                  <p className="text-base tracking-wide text-white-500">
                    Operation Officer
                  </p>
                </div>
              </div>
              <div className="w-full lgl:w-[60%] h-full flex flex-col justify-between">
                ...
                <div className="w-full h-[70%] py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] rounded-lg shadow-shadowOne p-4 lgl:p-8 flex flex-col justify-center gap-4 lgl:gap-8">
                  <div className="flex flex-col justify-between py-6 border-b-2 lgl:items-center border-b-gray-900">
                    <div>
                      <h3 className="text-xl font-medium tracking-wide text-white lgl:text-2xl font-bodyFont">
                        Travel Mobile App Design.
                      </h3>
                      <p className="mt-3 text-base tracking-wide text-white font-bodyFont">
                  ...
                  <p className="text-base font-medium leading-6 tracking-wide text-white font-bodyFont">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. A
                    dolorum, eos natus ipsum numquam veniam officia
                    necessitatibus ratione quos debitis exercitationem
                    repudiandae facilis id neque nihil accusantium perspiciatis
            ...
            <div className="flex flex-col justify-between w-full h-auto lgl:flex-row">
              <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-8 rounded-lg shadow-shadowOne flex flex-col md:flex-row lgl:flex-col gap-8 justify-center md:justify-start lgl:justify-center">
                ...
                <div className="flex flex-col justify-end w-full">
                  ...
                  <h3 className="text-2xl font-bold tracking-wide text-white font-bodyFont">Jone Duone Joe</h3>
                  <p className="text-base tracking-wide text-gr-500">
                    Operation Officer
                  </p>
                </div>
              </div>
