  ...
  return (
    <div className='form-overlay'>
      <div className='form-container'>
        ...
        {TestimonyToUpdate &&
          TestimonyToUpdate.image &&
          <img
            className='image-preview'
            src={TestimonyToUpdate.image}
            alt='Testimony Image'
          />}
        <form className='add-update-form' onSubmit={handleSubmit(topost)}>
          ...
          <label htmlFor='name' className='add-update-form-label'>
            name:
            <input type='text' id='name' name='name' {...register('name')} />
          </label>

          <label className='add-update-form-label' htmlFor='maintestimony'>
            maintestimony:
            <textarea
              id='maintestimony'
              name='maintestimony'
          ...
          <label className='add-update-form-label' htmlFor='contacts'>
            contacts:
          </label>
          <input
            type='text'
            ...
            {...register('contacts')}
          />
          <label className='add-update-form-label' htmlFor='rating'>
            rating:
            <input
              type='text'
              id='rating'
