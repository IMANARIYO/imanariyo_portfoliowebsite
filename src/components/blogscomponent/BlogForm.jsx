  ...
  const topost = async data => {
    ...
    try {
      ...
      if (BlogToUpdate) {
        ...
        const response = await axios.post(`${url}/Blogs/createBlog`, formData, {
          headers: {
            'Content-Type': 'multipart/form-data'
          }
        })
      ...
      <div className='form-container'>
        ...
        {BlogToUpdate &&
          ...
          <img
            ...
            src={BlogToUpdate.image}
            alt='Blog Image'
          />}
        <form className='add-update-form' onSubmit={handleSubmit(topost)}>
          <label htmlFor='image' className='add-update-form-label'>
            Image URL:
            <input
              type='file'
              accept='image/*'
          ...
          <label htmlFor='title' className='add-update-form-label'>
            Title:
            <input type='text' id='title' name='title' {...register('title')} />
          </label>

          <label className='add-update-form-label' htmlFor='description'>
            Description:
            <textarea
              id='description'
              name='description'
          ...
          <label className='add-update-form-label' htmlFor='category'>
            Category:
          </label>
          <input
            type='text'
            ...
            {...register('category')}
          />
          <label className='add-update-form-label' htmlFor='readmin'>
            Readmin:
            <input
              type='text'
              id='readmin'
